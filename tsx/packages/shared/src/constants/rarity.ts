...
export const RARITY_CONFIG: Record<RarityTier, RarityConfig> = {
  ...
  rare: {
    colors: {
      ...
      gradientHover: 'from-primary-300 to-primary-500',
      solid: '#32B8C6',
      text: 'text-primary-400',
      glow: 'rgba(50, 184, 198, 0.5)',
  ...
  mythic: {
    colors: {
      gradient: 'from-pink-500 via-primary-500 to-cyan-500',
      gradientHover: 'from-pink-400 via-primary-400 to-cyan-400',
      solid: '#EC4899',
      text: 'text-pink-400',
      glow: 'rgba(236, 72, 153, 0.6)',
      border: 'border-pink-400',
      bg: 'bg-gradient-to-r from-pink-500 via-primary-500 to-cyan-500',
    },
