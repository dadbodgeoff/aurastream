...
/**
 * Quick Create Redirect Page
 * 
 * Redirects to /dashboard/create?tab=templates
 * Shows one-time toast notification about the move.
 * 
 * Part of UX Consolidation 2025 - Task 2.7
 */
export default function QuickCreateRedirectPage() {
  ...
  useEffect(() => {
    ...
    router.replace('/dashboard/studio?tab=templates');
  }, [router]);
