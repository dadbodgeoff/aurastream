    ...
    <>
      ...
      <div className="fixed bottom-4 right-4 z-30 flex flex-col gap-2">
        ...
        >
          ...
          {unreadCount > 0 && (
            <span className="absolute -top-1 -right-1 min-w-[18px] h-[18px] px-1 flex items-center justify-center text-micro font-medium text-white bg-interactive-600 rounded-full">
        ...
        >
          ...
          {pendingRequests > 0 && (
            <span className="absolute -top-1 -right-1 min-w-[18px] h-[18px] px-1 flex items-center justify-center text-micro font-medium text-white bg-accent-500 rounded-full">
