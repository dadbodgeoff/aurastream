...
export const TEMPLATES: QuickTemplate[] = [
  ...
  },
  {
    ...
    vibes: [
      ...
      { id: 'anime', name: 'Retro Arcade', tagline: 'Neon CRT monitors synthwave', icon: '🕹️', gradient: 'from-purple-600 to-pink-600' },
      { id: 'playful', name: 'Colorful Calendar', tagline: '3D blocks with cute icons', icon: '🎨', gradient: 'from-cyan-500 to-blue-600' },
    ],
  },

  {
    ...
    vibes: [
      ...
      { id: 'anime', name: 'Energy Burst', tagline: 'Anime speed lines', icon: '⚡', gradient: 'from-purple-600 to-pink-600' },
  ...
  },
  {
    ...
    vibes: [
      ...
      { id: 'anime', name: 'Manga Panel', tagline: 'Dramatic speed lines', icon: '📖', gradient: 'from-purple-600 to-pink-600' },
      { id: 'playful', name: 'Pop Victory', tagline: 'Chibi celebration', icon: '🎉', gradient: 'from-cyan-500 to-blue-600' },
    ],
  },
  {
    ...
    vibes: [
      ...
      { id: 'anime', name: 'Level Up', tagline: 'Anime power-up auras', icon: '⬆️', gradient: 'from-purple-600 to-pink-600' },
      { id: 'playful', name: 'Pop-Art Party', tagline: 'Comic speech bubbles', icon: '🎊', gradient: 'from-cyan-500 to-blue-600' },
    ],
  },
  {
    ...
    fields: [
      ...
      { id: 'background_scheme', label: 'Background Colors', type: 'select', showForVibes: ['color-pop'], options: [
        { value: 'vibrant purple and cyan gradient', label: '💜 Purple & Cyan' },
        { value: 'fiery orange and red gradient', label: '🔥 Orange & Red' },
        { value: 'electric blue and neon green', label: '⚡ Blue & Green' },
        { value: 'sunset pink and gold', label: '🌅 Pink & Gold' },
        { value: 'deep navy and silver', label: '🌙 Navy & Silver' },
        { value: 'lime green and black', label: '🎮 Lime & Black' },
        { value: 'hot pink and electric purple', label: '💖 Pink & Purple' },
        { value: 'teal and coral', label: '🐚 Teal & Coral' },
        { value: 'crimson red and dark gray', label: '🎯 Red & Gray' },
        { value: 'golden yellow and royal blue', label: '👑 Gold & Blue' },
      ]},
    ],
  ...
  },
  {
    ...
    vibes: [
      ...
      { id: 'anime', name: 'Neon Sign', tagline: 'Glowing tubes on brick', icon: '💡', gradient: 'from-purple-600 to-pink-600' },
  ...
  },
  {
    ...
    vibes: [
      ...
      { id: 'anime', name: 'Anime Away', tagline: 'Cute chibi waving', icon: '👋', gradient: 'from-purple-600 to-pink-600' },
      { id: 'playful', name: 'Cozy Desk', tagline: 'Moonlight ambiance', icon: '🌙', gradient: 'from-indigo-600 to-purple-600' },
    ],
  },
];
